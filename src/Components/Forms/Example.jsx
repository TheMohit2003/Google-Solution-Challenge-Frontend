...
const validationSchema = Yup.object().shape({
    ...
    retire_initiator_comments: Yup.string().required('Retire Initiator Comments are required'),
});
                    ...
                    <div className="row details-container w-100">
                        <div className="col-4">
                            <div className="input-container">
                                ...
                                >
                                    <Select.Option value="CAPA No Longer Needed">CAPA No Longer Needed</Select.Option>
                                    <Select.Option value="Process Change">Process Change</Select.Option>
                        ...
                        <div className="col-12">
                            <div className="textarea-container">
                                ...
                                />
                                {errors.retire_initiator_comments && touched.retire_initiator_comments && (
                                    <small className="form-err">{errors.retire_initiator_comments}</small>
                                )}
                                <small className="small-text">
                                    {values.retire_initiator_comments ? values.retire_initiator_comments.length : '0'}/550
                                </small>
                            </div>
                        </div>
                        <div className="col-12">
                            <Field name="attachment" as={Upload} showUploadList={false} beforeUpload={beforeUpload}>
                        ...
                        <div className="col-12 justify-content-end w-100">
                            <Button type="primary" htmlType="submit" className="mt-4 float-right">
                                Submit
                            </Button>
                        </div>
                    </div>
