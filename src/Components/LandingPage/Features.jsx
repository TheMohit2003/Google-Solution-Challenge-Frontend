...
export default function Features() {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Features</h2>
      <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">Empowering Your Service Journey</h1>
    </div>
    <div class="flex flex-wrap -m-4 lg:w-max-5xl mx-auto">
    {featureCards.map(ele =>(
        ...
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          <div class="flex items-center mb-3">
            ...
            <h2 class="text-gray-900 text-lg title-font font-medium">{ele.title}</h2>
          </div>
          <div class="flex-grow">
            <p class="leading-relaxed text-base">{ele.info}</p>
          </div>
        </div>
      </div>
    ))} 
